                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control" name="name" value="{{old('name',$contestant->name)}}" placeholder="Name" required id="">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mb-4" value="{{ $contestant->matric_number }}" required name="matric_number" placeholder="Matric Number" id="">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control mb-4" value="{{ $contestant->email }}" required name="email" placeholder="Email Address" id="">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mb-4" value="{{ $contestant->phone }}" required name="phone" placeholder="Phone Number" id="">
                        </div>
                    </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select name="department" id="department" data-control="select2" data-placeholder="Select a department " class="form-select mb-2">
                                ...
                                @foreach(\App\Department::orderBy('name')->get() as $value)
                                    <option value="{{ $value->id }}" {{ ($value->id == $contestant->department_id) ? 'selected' : '' }}> {{ ucwords($value->name) }}</option>
                                @endforeach
                            </select>
                            <!--end::Input-->
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select name="level" id="level" data-control="select2" data-placeholder="Select a level " class="form-select mb-2">
                                ...
                                @foreach(array('ND 1 FT','ND 1 DPT','ND 1 PTYR','ND 2 PTYR','ND 3 PTYR','ND 2 FT','ND 2 DPT','HND 1 FT','HND 1 DPT','HND 2 FT','HND 2 DPT') as $value)
                                    <option value="{{ $value }}" {{ ($value == $contestant->level) ? 'selected' : '' }}>{{ ucwords($value) }}</option>
                                @endforeach
                            </select>
                            <!--end::Input-->
                        </div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control" name="alias" value="{{old('alias',$contestant->alias)}}" placeholder="Alias" required id="">
                        </div>
                    </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select name="sex" id="sex" data-control="select2" data-placeholder="Select a sex " class="form-select mb-2">
                                ...
                                @foreach(array('male','female') as $value)
                                    <option value="{{$value}}" {{ ($value == $contestant->sex ) ? 'selected' : '' }}>{{ ucwords($value) }}</option>
                                @endforeach
                            </select>
                            <!--end::Input-->
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select name="program" id="program" data-control="select2" data-placeholder="Select a program " class="form-select mb-2">
                                ...
                                @foreach(array('National Diploma','Higher National Diploma') as $value)
                                    <option value="{{$value}}" {{ ($value == $contestant->program) ? 'selected' : '' }}>{{ ucwords($value) }}</option>
                                @endforeach
                            </select>
                            <!--end::Input-->
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select name="post" id="post" data-control="select2" data-placeholder="Select a post " class="form-select mb-2">
                                ...
                                @foreach(\App\Posts::orderBy('name')->get() as $value)
                                    <option value="{{ $value->id }}" {{ ($value->id == $contestant->post_id) ? 'selected' : '' }}>  {{ ucwords($value->name) }}</option>
                                @endforeach
                            </select>
                            <!--end::Input-->
                        </div>
